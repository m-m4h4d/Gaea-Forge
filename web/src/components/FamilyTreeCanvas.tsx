...
export default function FamilyTreeCanvas({
  ...
  return (
    <div className="w-full h-full flex flex-col bg-slate-950 text-parchment relative overflow-hidden select-none">
      ...
      <div className="bg-slate-900/90 border-b border-slate-800 p-2.5 sm:p-3 flex items-center justify-between gap-2 shrink-0 z-30 backdrop-blur-md overflow-x-auto custom-scrollbar">
